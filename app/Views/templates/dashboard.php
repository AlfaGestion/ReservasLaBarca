            ...
            <?php else : ?>
                ...
                <div class="container-fluid">
                    ...
                    <?php if ($userBackground) : ?>
                        ...
                        <div class="mx-auto d-lg-none"> <!-- Centra en dispositivos móviles -->
                            <a class="navbar-brand" href="<?= base_url() ?>">
                                <img src="<?= base_url(PUBLIC_FOLDER . "assets/images/wlogo.png") ?>" width="350px" alt="">
                            </a>
                        </div>
                    ...
                    <?php else : ?>
                        ...
                        <div class="mx-auto d-lg-none"> <!-- Centra en dispositivos móviles -->
                            <a class="navbar-brand" href="<?= base_url() ?>">
                                <img src="<?= base_url(PUBLIC_FOLDER . "assets/images/logo.png") ?>" width="350px" alt="">
                            </a>
                        </div>

                        <div class="mx-auto d-none d-lg-block"> <!-- Centra en pantalla grande -->
                            <a class="navbar-brand" href="<?= base_url() ?>">
                                <img src="<?= base_url(PUBLIC_FOLDER . "assets/images/logo.png") ?>" width="500px" alt="">
                            </a>
                        </div>
                    <?php endif; ?>
