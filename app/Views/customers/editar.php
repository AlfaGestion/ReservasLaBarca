...
<link rel="stylesheet" href="<?= base_url(PUBLIC_FOLDER . 'assets/css/customer-editor.css?v=' . $customerOfferCssVersion) ?>">
<?php echo $this->endSection() ?>
        ...
        <header class="customer-editor-header">
            <div class="customer-editor-header__brand">
                ...
                <div>
                    ...
                    <p class="customer-editor-subtitle">
                        Editá los datos del cliente y su oferta personalizada sin salir del panel. La navegación del admin se mantiene visible arriba y abajo.
                    </p>
                </div>
            </div>
            <div class="customer-editor-header__meta">
                ...
                <p class="customer-editor-note">
                    Esta configuración se guarda por cliente y se aplica después en reservas y Mercado Pago.
                </p>
            </div>
        </header>
                ...
                <section class="customer-editor-card">
                    <div class="customer-editor-card__header">
                        <div>
                            ...
                            <p class="customer-editor-card__subtitle">Mantené actualizados nombre, documento, teléfono y localidad.</p>
                        </div>
                    </div>
                ...
                <section class="customer-editor-card">
                    <div class="customer-editor-card__header">
                        <div>
                            ...
                            <p class="customer-editor-card__subtitle">Definí el porcentaje, la vigencia y sobre qué canchas o servicios aplica.</p>
                        </div>
